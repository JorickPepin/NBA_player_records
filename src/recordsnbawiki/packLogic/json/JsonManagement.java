...
public class JsonManagement {
    ...
    private void retrieveTeamNames() throws FileNotFoundException {
        ...
        try {
            JsonReader reader = new JsonReader(new InputStreamReader(this.getClass().getClassLoader().getResourceAsStream("data/teams.json"), StandardCharsets.UTF_8));
    ...
    private void retrieveStatNames() throws FileNotFoundException {
        ...
        try {
            JsonReader reader = new JsonReader(new InputStreamReader(this.getClass().getClassLoader().getResourceAsStream("data/stats.json"), StandardCharsets.UTF_8));
